...
class Fun {
      ...
      this.prom
        .then(([res]) => {
          ...
          if (isAll) {
            ...
            // 如果非首次显示
            const index = swan.getStorageSync(key); // 获取当前显示索引
  ...
  subMsg(msg, isClick = false) {
    ...
    if (isRun) {
      ...
      swan.setStorageSync(key, nextIndex);
    }
  }
...
//                url: `https://${this.domain}/common/session/sign_in`,
									url: `https://${this.domain}/common/baidu/sign_in`,	
                  data: {
