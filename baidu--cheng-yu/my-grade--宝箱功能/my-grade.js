...
//		  	},
		  	//点击的音效
		  	playMusic: function() {
		  		let let_url = comp.data.musics.anser_click
		  	...
		  	clickTime: function() {
		  		var self = this
		  		//19.2.25新增音效
//				comp.audioPlay('anser_click')
//				//使用背景音乐
//				app.playBackgroundAudioManager(comp.data.musics.anser_click)
				self.playMusic()
